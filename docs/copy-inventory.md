...
| COPY_DASHBOARD_MODE_MEANING_FRAGMENTED_01 | `src/lib/week-analysis.ts` | `Stay modular—deep work will be harder than it looks.` | Conditional/Adaptive | When day mode resolves to `fragmented` | None | Daily operating mode |
...
| COPY_DASHBOARD_MODE_MEANING_PROTECTED_01 | `src/lib/week-analysis.ts` | `Protect one real work block—that is the win.` | Conditional/Adaptive | When day mode resolves to `protected_work` | None | Daily operating mode |
